...
<xsl:output method="xml" version="1.0" doctype-public="-//W3C//DTD XHTML 1.0 Transitional//EN" doctype-system="http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd" media-type="text/html" encoding="utf-8" indent="yes" />
    ...
    <xsl:template match="phrase">
        ...
        <xsl:element name="audio">
                ...
                <xsl:element name="source">
                        <xsl:attribute name="src">
                                <xsl:value-of select="concat('audio/',$id,'.mp3')"/>
                        </xsl:attribute>
                        <xsl:attribute name="type">
                ...
                <object id="ie1" classid="clsid:6BF52A52-394A-11D3-B153-00C04F79FAA6" width="200" height="45" type="audio/mpeg" data="audio/]]><xsl:value-of select="$id"/><![CDATA[.mp3">
                <param name="src" value="audio/]]><xsl:value-of select="$id"/><![CDATA[.mp3" />
